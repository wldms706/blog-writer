  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-white/10 backdrop-blur p-8 border border-white/10">
        <h2 className="mb-6 text-lg font-bold text-white">회원가입</h2>
        <div className="space-y-3">
          ...
          >
            ...
            {socialLoading ? '가입 중...' : 'Google로 시작하기'}
          </button>
        </div>
      ...
      <p className="text-center text-xs text-white/50">
        이미 계정이 있으신가요?{' '}
        <Link href="/login" className="font-bold text-[#3B5CFF] hover:underline">
          로그인
        </Link>
      </p>
    </div>
