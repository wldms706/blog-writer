      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl bg-[#3B5CFF]/5 border border-[#3B5CFF]/20 p-5">
          ...
          <p className="mb-4 text-xs text-gray-500">
            답변을 작성하면 글에 원장님의 신념과 철학이 자연스럽게 녹아듭니다.<br/>
            필수 아니지만, 채울수록 개성 있는 글이 나와요!
          </p>
          <div className="space-y-4">
            {[
          ...
          {(profile.storyMotivation || profile.storyPriority || profile.storyDifference || profile.storyMessage || profile.storyReward) && (
