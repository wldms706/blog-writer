      ...
      <header className="sticky top-0 z-50 bg-black text-white">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
          ...
          <nav className="flex items-center gap-1 sm:gap-2">
            <Link href="/write" className="rounded-full px-3 sm:px-4 py-1.5 text-xs sm:text-sm text-white/70 hover:text-white hover:bg-white/10 transition-colors">
              블로그
            </Link>
            <Link href="/caption" className="rounded-full px-3 sm:px-4 py-1.5 text-xs sm:text-sm text-white/70 hover:text-white hover:bg-white/10 transition-colors">
              인스타
            </Link>
