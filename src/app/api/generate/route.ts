...
${brandingType === 'story' ? (isRegulatedBusiness ? `
### 정보성 글 구조 (규제 업종):
⚠️ 샵 스토리가 아닌, 업계 정보 전달 글로 작성하세요.
1. 눈썹문신/반영구 시술을 고민하는 사람들의 일반적인 상황
2. 좋은 시술 공간을 고르는 기준 (위생, 분위기, 상담 환경 등)
3. 시술 전 확인해야 할 사항들
4. 시술 후 관리와 주의사항
5. 마무리: 신중하게 선택하라는 조언
- 절대 금지: 특정 샵/시술자 언급, 자기 홍보, 고객 만족 언급
