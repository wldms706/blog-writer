...
⚠️⚠️⚠️ 글자수: [편집가이드: ...] 부분을 제외한 순수 본문만 공백 제외 1,500자 이상 반드시 작성
- 편집가이드는 글자수에 포함하지 마세요
- 편집가이드를 삭제해도 본문이 1,500자 이상이어야 합니다`;
...
⚠️⚠️⚠️ 글자수: [편집가이드: ...] 부분을 제외한 순수 본문만 공백 제외 1,400~1,600자로 작성
- 편집가이드는 글자수에 포함하지 마세요
- 편집가이드를 삭제해도 본문이 1,400자 이상이어야 합니다`;
    }
