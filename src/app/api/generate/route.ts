...
⚠️⚠️⚠️ 글자수 (절대 규칙 — 어기면 글 전체 거부):
- [편집가이드: ...] 줄을 전부 삭제한 뒤 남는 순수 본문이 공백 제외 1,500자 이상이어야 합니다
- 1,500자 미만이면 무조건 거부입니다. 넉넉하게 1,600~1,800자를 목표로 작성하세요
- 각 소제목 섹션을 3문단 이상 충실하게 쓰면 자연스럽게 달성됩니다
- 짧게 끝내지 마세요. 독자가 읽을 거리가 충분해야 합니다`;
