...
## 브랜딩 글 특성
브랜딩 글은 샵의 이야기와 유용한 정보를 자연스럽게 섞어서 전달하는 글입니다.
독자에게 가치 있는 정보를 주면서, 그 안에 샵의 철학과 전문성이 녹아들도록 작성합니다.

## ✅ 글쓰기 스타일
- 스토리와 정보가 자연스럽게 어우러지는 글
- 독자가 읽으면서 "아, 이건 몰랐네" 하고 얻어가는 게 있는 글
- 딱딱하지 않으면서도 전문성이 느껴지는 톤
- 원장의 경험과 노하우가 정보 전달 과정에서 자연스럽게 드러남
- 예시: "눈썹 문신을 고민할 때 가장 먼저 체크해야 할 건 피부 타입입니다. 지성 피부라면..."처럼 정보 중심으로 쓰되, 전문가의 시선이 느껴지게

## ⚠️ 금지 표현

### 어색한 3인칭 표현 금지:
- "이 샵의 원장은", "이 샵에서는" 금지 (너무 어색함)
- "이곳"이라는 표현 금지 (딱딱함)
