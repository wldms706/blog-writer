...
- "첫째, 둘째, 셋째" 패턴 사용 금지
- "첫 번째, 두 번째" 패턴 사용 금지
- 번호를 붙여 나열하는 방식 절대 금지
- 단락을 나눠 각 주제를 설명하되, 기계적인 나열은 피하기

### ⚠️⚠️⚠️ 뻔한 체크리스트형 반복 패턴 절대 금지 (가장 중요):
아래와 같은 "어떤 글이든 다 붙여넣을 수 있는" 뻔한 항목 나열은 절대 금지합니다.
이런 글은 검색엔진에서도, 독자에게도 가치가 없습니다.

❌ 절대 쓰면 안 되는 패턴 예시:
- "시술자의 전문성과 경험이 중요합니다" → 너무 당연한 말
- "위생 관리가 중요합니다" → 모든 시술에 해당하는 뻔한 말
- "색소의 품질을 확인해야 합니다" → 매번 나오는 반복
- "맞춤형 디자인이 중요합니다" → 모든 뷰티 글에 복붙 가능
- "사후 관리를 잘 해야 합니다" → 어떤 시술이든 해당
- "포트폴리오를 확인하세요" → 너무 뻔함
- "충분한 상담을 통해" → 매번 같은 말
- "안전성이 검증된" → 모든 글에 복붙 가능

✅ 대신 이렇게 써야 합니다:
- 이 키워드/주제에서만 의미 있는 구체적인 이야기
- "다들 아는 정보"가 아니라 "이건 몰랐을 정보"
- 검색한 사람이 "아 이건 여기서만 볼 수 있는 내용이네" 하는 글
- 해당 시술/주제의 구체적인 원리, 실제 케이스, 현장 경험에서 나온 디테일

❌ 자가 점검: 내가 쓴 문단이 "키워드만 바꾸면 다른 시술에도 쓸 수 있는 내용"이면 삭제하고 다시 쓰세요.
...
- "포트폴리오를 확인하세요"
- "충분한 상담을 통해"
- 이런 뻔한 항목을 순서대로 나열하는 글은 가치가 없습니다.

✅ 대신: 이 키워드/주제에서만 의미 있는 구체적인 원리, 기술적 디테일, 실제 케이스를 다루세요.
❌ 자가 점검: "키워드만 바꾸면 다른 시술에도 쓸 수 있는 내용"이면 삭제하고 다시 쓰세요.
...
⚠️ 뻔한 체크리스트 나열 금지:
- "전문성 확인 → 위생 확인 → 색소 확인 → 디자인 → 사후관리" 이 패턴으로 쓰면 글이 거부됩니다
- 이 주제에서만 쓸 수 있는 구체적이고 고유한 내용으로 작성하세요
` : ''}
