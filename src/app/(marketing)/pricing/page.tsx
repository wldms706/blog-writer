...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'SEO 최적화 글쓰기', included: true },
      { text: '무제한 히스토리', included: true },
      { text: '업종추천: 헤어,왁싱,속눈썹,네일,피부', included: true },
    ],
    cta: '프로 시작하기',
    ctaLink: '/subscribe',
    highlighted: false,
  },
  {
    ...
    originalPrice: '4,900',
    period: '/월',
    description: '인스타 캡션만 가볍게 시작',
    badge: '캡션 전용',
    discount: '특가',
    features: [
      { text: '인스타 캡션 무제한 생성', included: true },
      { text: '5가지 캡션 스타일', included: true },
      { text: '다국어 자동 번역 (영/일/중)', included: true },
      { text: '뷰티샵 원장 무드 적용', included: true },
      { text: '블로그 글 무제한', included: false },
